...
win32:isEmpty(QTCREATOR_SOURCES):QTCREATOR_SOURCES=C:\Users\x.coponet\Documents\Qt\qt-creator-opensource-src-4.3.1

## set the QTC_BUILD environment variable to override the setting here
IDE_BUILD_TREE = $$(QTC_BUILD)
unix:isEmpty(IDE_BUILD_TREE):IDE_BUILD_TREE=$$(HOME)/qtcreator-4.3.0
win32:isEmpty(IDE_BUILD_TREE):IDE_BUILD_TREE=C:\Users\x.coponet\Documents\Qt\build-qtcreator-Desktop_Qt_5_9_1_MSVC2015_32bit-Release
